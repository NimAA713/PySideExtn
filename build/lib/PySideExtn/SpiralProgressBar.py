...
#           from PySide2extn import spiralProgressBar                                         #
...
try:
    ...
    from PySide2.QtGui import QColor, QPainter, QPen, QPaintEvent
except ImportError:
...
#------------------------------------------------------METHODS FOR CHANGING THE PROPERTY OF THE SPIRALPROGRESSBAR :SOLTS
    ...
    def spb_setNoProgressBar(self, num):
        ...
        """
        if not isinstance(num, int):                            # MAKING SURE THAT THE ENTERED IS A NUMBER AND NOT A STRING OR OTHERS
    ...
    def spb_setValue(self, value):                                 # value: TUPLE OF (value1, value2, value3)
        ...
        if not isinstance(value, tuple):                                  # IF INPUT IS NOT A TUPLE
    ...
    def spb_setMaximum(self, maxVal):
        ...
        if not isinstance(maxVal, tuple):                              # IF INPUT IS NOT A TUPLE
    ...
    def spb_setMinimum(self, minVal):
        ...
        if not isinstance(minVal, tuple):                              # IF INPUT IS NOT A TUPLE
    ...
    def spb_setRange(self, minTuple, maxTuple):
        ...
        if not isinstance(minTuple, tuple) or not isinstance(maxTuple, tuple):
    ...
    def spb_setInitialPos(self, position):
        ...
        if not isinstance(position, tuple):                                  # IF INPUT IS NOT A TUPLE
            ...
            for each in range(0, self.noProgBar, 1):
                if not isinstance(position[each], str):
    ...
    def spb_setGeometry(self, posX, posY):
        ...
        if not isinstance(posX, int) or not isinstance(posY, int):
            raise Exception(f"Position should be a int and not: X ({str(type(posX))}), Y ({str(type(posY))})")
            return
    ...
    def spb_setDirection(self, direction):
        ...
        if not isinstance(direction, tuple):                                  # IF INPUT IS NOT A TUPLE
            ...
            for each in range(0, self.noProgBar, 1):
                if not isinstance(direction[each], str):
    ...
    def spb_lineWidth(self, width):
        ...
        if not isinstance(width, int):
            raise Exception(f"Width should be an Integer and not {str(type(width))}")
        else:
    ...
    def spb_lineColor(self, color):
        ...
        elif not isinstance(color[0], tuple):
    ...
    def spb_lineStyle(self, style):
        ...
        if not isinstance(style, tuple):
            ...
            for each in range(0, self.noProgBar, 1):
                if not isinstance(style[each], str):
    ...
    def spb_lineCap(self, cap):
        ...
        if not isinstance(cap, tuple):
            ...
            for each in range(0, self.noProgBar, 1):
                if not isinstance(cap[each], str):
    ...
    def paintEvent(self, event: QPaintEvent):
        ...
        if self.pathPresent:
            for path in range(0, self.noProgBar, 1):
                ...
                painter.setPen(self.penPath)
                painter.drawArc(self.positionX + self.posFactor + self.spb_cngSize * spiralIncrem2,
                                self.positionY + self.posFactor + self.spb_cngSize * spiralIncrem2,
                                self.spb_Size - self.sizeFactor - 2 * self.spb_cngSize * spiralIncrem2,
                                self.spb_Size - self.sizeFactor - 2 * self.spb_cngSize * spiralIncrem2,
        ...
        for bar in range(0, self.noProgBar, 1):
            ...
            painter.drawArc(self.positionX + self.posFactor + self.spb_cngSize * spiralIncrem,
                            self.positionY + self.posFactor + self.spb_cngSize * spiralIncrem,
                            self.spb_Size - self.sizeFactor - 2 * self.spb_cngSize * spiralIncrem,
                            self.spb_Size - self.sizeFactor - 2 * self.spb_cngSize * spiralIncrem,
